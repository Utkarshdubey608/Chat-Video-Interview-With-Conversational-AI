...
Date: 2026-08-11
Scope: restrict the desktop client (`mobile_desktop_app_version/`, Windows + macOS) to
...
- **Website-only features** (Hume, AWS Rekognition, Daily.co two-way calls,
  ...
  the prior report's finding that none of these exist in `mobile_desktop_app_version` or
  `backend`.
