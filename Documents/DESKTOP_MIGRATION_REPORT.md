...
Date: 2026-08-11
Scope: `mobile_desktop_app_version/` (Flutter client), informed by `backend/` (FastAPI) and the
...
Why this was viable: `mobile_desktop_app_version` already had `windows/` and `macos/`
...
| Feature | Website | mobile_desktop_app_version (mobile) | Backend | Desktop |
|---|---|---|---|---|
...
**Bottom line on parity:** every feature that exists in `mobile_desktop_app_version` (the
...
| `windows/runner/main.cpp`, `windows/runner/Runner.rc` | Window title/branding "Talbotiq" (was `mobile_desktop_app_version`/`com.example`), default size 1440×900 |
